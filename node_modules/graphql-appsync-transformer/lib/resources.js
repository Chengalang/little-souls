...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.makeEnvironmentConditions = function () {
        var _a;
        return _a = {},
            _a[graphql_transformer_common_1.ResourceConstants.CONDITIONS.HasEnvironmentParameter] = cloudform_1.Fn.Not(cloudform_1.Fn.Equals(cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.Env), graphql_transformer_common_1.ResourceConstants.NONE)),
            _a;
    };
