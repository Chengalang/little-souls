...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.joinWithEnv = function (separator, listToJoin) {
        return cloudform_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.HasEnvironmentParameter, cloudform_1.Fn.Join(separator, listToJoin.concat([
            cloudform_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.Env)
        ])), cloudform_1.Fn.Join(separator, listToJoin));
    };
    /**
    ...
    ResourceFactory.prototype.domainName = function () {
        return cloudform_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.HasEnvironmentParameter, cloudform_1.Refs.NoValue, cloudform_1.Fn.Join('-', [
            'd',
            cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId')
        ]));
    };
    ResourceFactory.prototype.domainArn = function () {
        return cloudform_1.Fn.GetAtt(graphql_transformer_common_1.ResourceConstants.RESOURCES.ElasticSearchDomainLogicalID, "DomainArn");
    };
    /**
